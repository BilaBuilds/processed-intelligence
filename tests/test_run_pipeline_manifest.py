    ...
    def test_pattern_failure_is_non_blocking(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            module_map = {
                ...
                "src": src,
                "src.outreach_state": src.outreach_state,
                ...
                "src.patterns": types.SimpleNamespace(run=lambda context: (_ for _ in ()).throw(RuntimeError("pattern boom"))),
...
""".strip(),
            ...
            module_map = {
                ...
                "src.product_runner": types.SimpleNamespace(
                    run_all_products=lambda **kwargs: {
                        "status": "ok",
                        "enabled_count": 0,
                        "generated_count": 0,
                        "outputs": {},
